...
public extension UIColor {
    ...
    static var accent: UIColor {
        return UIColor(light: .withColorStudio(.pollexaPurple, shade: .shade60),
                       dark: .withColorStudio(.pollexaPurple, shade: .shade30))
    }

    /// Accent Dark. Purple-70 (Light Mode) and Purple-50 (Dark Mode)
    ///
    static var accentDark: UIColor {
        return UIColor(light: .withColorStudio(.pollexaPurple, shade: .shade80),
                       dark: .withColorStudio(.pollexaPurple, shade: .shade50))
    }

    /// Brand. pollexaPurple-60 (all versions of iOS, Light and Dark Mode)
    ///
    ...
    /// Primary. pollexaPurple-60 (< iOS 13 and Light Mode) and pollexaPurple-30 (Dark Mode)
    ///
...
public extension UIColor {
    ...
    static var selectableSecondaryButtonSelectedBorder: UIColor {
        .init(light: .withColorStudio(.pollexaPurple, shade: .shade50),
              dark: .withColorStudio(.pollexaPurple, shade: .shade30))
    }
...
public extension UIColor {
    ...
    static var listSelectedBackground: UIColor {
        return UIColor(light: UIColor.pollexaPurple(.shade0), dark: UIColor.pollexaPurple(.shade10))
    }
...
// MARK: - Woo Purples
public extension UIColor {
    class func pollexaPurple(_ shade: ColorStudioShade) -> UIColor {
        switch shade {
        case .shade0:
            return UIColor(light: .withColorStudio(.pollexaPurple, shade: .shade0), dark: .withColorStudio(.pollexaPurple, shade: .shade100))
            case .shade5:
                return UIColor(light: .withColorStudio(.pollexaPurple, shade: .shade5), dark: .withColorStudio(.pollexaPurple, shade: .shade90))
            case .shade10:
                return UIColor(light: .withColorStudio(.pollexaPurple, shade: .shade10), dark: .withColorStudio(.pollexaPurple, shade: .shade80))
            case .shade20:
                return UIColor(light: .withColorStudio(.pollexaPurple, shade: .shade20), dark: .withColorStudio(.pollexaPurple, shade: .shade70))
            case .shade30:
                return UIColor(light: .withColorStudio(.pollexaPurple, shade: .shade30), dark: .withColorStudio(.pollexaPurple, shade: .shade60))
            case .shade40:
                return UIColor(light: .withColorStudio(.pollexaPurple, shade: .shade40), dark: .withColorStudio(.pollexaPurple, shade: .shade50))
            case .shade50:
                return UIColor(light: .withColorStudio(.pollexaPurple, shade: .shade50), dark: .withColorStudio(.pollexaPurple, shade: .shade40))
            case .shade60:
                return UIColor(light: .withColorStudio(.pollexaPurple, shade: .shade60), dark: .withColorStudio(.pollexaPurple, shade: .shade30))
            case .shade70:
                return UIColor(light: .withColorStudio(.pollexaPurple, shade: .shade70), dark: .withColorStudio(.pollexaPurple, shade: .shade20))
            case .shade80:
                return UIColor(light: .withColorStudio(.pollexaPurple, shade: .shade80), dark: .withColorStudio(.pollexaPurple, shade: .shade10))
            case .shade90:
                return UIColor(light: .withColorStudio(.pollexaPurple, shade: .shade90), dark: .withColorStudio(.pollexaPurple, shade: .shade5))
            case .shade100:
                return UIColor(light: .withColorStudio(.pollexaPurple, shade: .shade100), dark: .withColorStudio(.pollexaPurple, shade: .shade0))
        }
    }
}
